        ...
        <div class="row">
            <div class="col-6 mx-auto">
                ...
                <form>
                    ...
                    <div class="mb-3">
                        <label for="exampleInputEmail1" class="form-label">Введите описание фильма</label>
                    ...
                    <div class="mb-3">
                        <label for="exampleInputEmail1" class="form-label">Введите год выпуска фильма</label>
                        <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                    </div>
                    <div class="mb-3">
                        <label for="exampleInputEmail1" class="form-label">Введите режессёра фильма</label>
                        <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                    </div>
                    <div class="mb-4">
                        <ButtonComponent 
